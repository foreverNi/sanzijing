...
- 复用根目录 `data.js` 的 197 页三字经内容，通过 `tools/generate-content.ps1` 生成 Android 内容类。
...
powershell -ExecutionPolicy Bypass -File .\tools\generate-illustration-pack.ps1
powershell -ExecutionPolicy Bypass -File .\tools\generate-audio-pack.ps1
```
